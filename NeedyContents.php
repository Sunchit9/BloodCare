   ...
   <link rel="stylesheet" href="font/font-awesome-4.7.0/css/font-awesome.min.css">
    ...
    <body>
     ...
     <button class="btn btn-outline-success my-2 my-sm-0" type="submit">SignOut</button>
        ...
        <div class="card-deck">
  <div class="card">
    <img class="card-img-top" src="img/fill.png" alt="Card image cap" height="60%">
    <div class="card-body">
        <h5 class="card-title"><a href="needyprofile.php">Create a Profile?</a></h5>
      <p class="card-text">Make your Needy Profile so that we can send you the available donors.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
    </div>
  </div>
  <div class="card">
    <img class="card-img-top" src="img/search.jpg" alt="Card image cap" height="60%">
    <div class="card-body">
        <h5 class="card-title"><a href="Combo.php">Search for blood?</a></h5>
      <p class="card-text">Find and contact donors of required blood nearby you.</p>
      <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
    </div>
  </div>
</div>
